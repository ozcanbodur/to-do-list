        ...
        // use strict
        // "use strict"; değişkenleri tanımlamaları mecbur tutar.
        // belli kurallara uymaya zorunlu tutar.
        ...
        function displayTasks(filter) {
            ...
            if (gorevListesi.length == 0) {
                ...
                ul.innerHTML = "<p class='p-3 m-0'>Görev Listesiniz Boş </p>"
  ...
  <ul class="dropdown-menu">
    ...
    <li><a onclick="deleteTask(${gorev.id})"  class="dropdown-item" href="#"><i class="fa-solid fa-trash-can"></i>Sil</a></li>
        ...
        let btnAdd = document.querySelector("#btnAddNewTask").addEventListener("click", newTask);
        ...
        function newTask(event) {
            ...
            if (taskInput.value == "") {
                ...
                if (!isEditTask) {
                    ...
                    //güncelleme işlemei
                    for (let gorev of gorevListesigorevListesi) {
                        if (gorev.id == editId) {
